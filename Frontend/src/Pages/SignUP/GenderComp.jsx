  ...
  return (
    <div className="flex gap-1 my-1">
      <div className="form-control flex align-center justify-center">
        ...
        <input type="checkbox" name="Male" className="checkbox bg-white"
         checked={selectedgender ==="Male"}
         onChange={()=>onCheckboxChange("Male")}
        />
         <span className="text-center px-5 text-white">Male</span>
        </label>
      </div>
      <div>
      <label htmlFor="" className={`flex justify-center align-center ${selectedgender==='Female'?"selected":""}`}>
         <span className="px-5 text-white">Female</span>
         <input type="checkbox" name="Female" className="checkbox bg-white"  
